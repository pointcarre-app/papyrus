...
class CORSRequestHandler(SimpleHTTPRequestHandler):
    def end_headers(self):
        ...
        # Enable cross-origin access for PDF generation resources
        self.send_header("Cross-Origin-Embedder-Policy", "require-corp")
        self.send_header("Cross-Origin-Opener-Policy", "same-origin")
        # Allow this resource to be fetched from other origins
...
if __name__ == "__main__":
    ...
    with ReusableTCPServer(("", PORT), CORSRequestHandler) as httpd:
        ...
        try:
            ...
            print("👋 " + "\033[1;33m" + "Thanks for using Papyrus Server!" + "\033[0m" + " 👋")
            print("=" * 60)
            httpd.shutdown()
